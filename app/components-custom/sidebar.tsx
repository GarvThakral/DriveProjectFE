...
export function Sidebar() {
  ...
  return (
    <div className="hidden w-64 flex-col border-r bg-background p-4 md:flex">
      ...
      <Button className="justify-start" variant="ghost" onClick = {()=>fetchStarred()}>
        <Star className="mr-2 h-4 w-4" />
        Starred
      </Button>
      <Button className="justify-start" variant="ghost" onClick = {()=>fetchTrashed()}>
